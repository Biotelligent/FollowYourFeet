/** File for row input types and validations
 * 
 */
...
function setTypePhone(control){
	...
	control.validate = validators.defaultValidator;
	control.maxLength = 13; // GB is 10, Germany is 13, will never be more than (16?) globally
}
...
function setTypeCurrency(control){
  control.keyboardType = KEYBOARD_DECIMAL_PAD;
  control.validate = validators.url;
}
